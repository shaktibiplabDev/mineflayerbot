...
module.exports = {
  ...
  async execute(interaction, bot) {
    await interaction.deferReply();  // Acknowledge the interaction early to avoid "Unknown interaction"
    ...
    try {
      ...
      const file = new AttachmentBuilder(canvas.toBuffer(), {
        name: `information.png`,  // Changed from .gif to .png
      ...
      console.error(err);
      await interaction.editReply("An error occurred while generating the bot's information.");
    }
  },
};
